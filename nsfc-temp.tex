...
\vskip -5mm
{\color{MsBlue} \subsection{\sihao \kaishu \quad \ （一）立项依据与研究内容(建议8000字以下)：}}%\textnormal{\kaishu 青年基金这句不加粗 }} 
...
2025-03-06: 根据2025年最新MsWord模板做了更新。主要更新了:（三）其他需要说明的情况中的部分蓝字（重要）; 另外关掉了hyperref，避免编译后的pdf中参考文献号码有绿色方框。
